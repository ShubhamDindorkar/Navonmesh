      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 lg:gap-16">
          ...
          <div className="flex flex-col items-center max-w-[250px]">
            <a href="https://iic.mic.gov.in/" target="_blank" rel="noopener noreferrer" className="w-48 h-48 flex items-center justify-center rounded-2xl bg-n-7 border border-n-6 mb-6 p-6 hover:bg-n-6 transition-colors">
              <img 
          ...
          <div className="flex flex-col items-center max-w-[400px]">
            <a href="https://despu.edu.in/" target="_blank" rel="noopener noreferrer" className="w-80 h-80 flex items-center justify-center rounded-2xl bg-n-7 border border-n-6 mb-6 p-8 hover:bg-n-6 transition-colors">
              <img 
                src={despuOrange}
          ...
          {/* Sponsor - IET (Right) */}
          <div className="flex flex-col items-center max-w-[250px]">
            <a href="https://india.theiet.org/" target="_blank" rel="noopener noreferrer" className="w-48 h-48 flex items-center justify-center rounded-2xl bg-n-7 border border-n-6 mb-6 p-6 hover:bg-n-6 transition-colors">
              <img 
